---
{"dg-publish":true,"permalink":"/工作/经纬度解析/","noteIcon":"","updated":"2023-12-16T16:03:18.503+08:00"}
---
...
      <canvas id="point-myCanvas" width="800" height="800"></canvas>

    </div>

    <div class="point-controls">

      <textarea id="point-inputText" placeholder="在这里输入内容，动态改变高度" width="100%"></textarea>

      <button id="point-generateButton" width="100%">生成</button>

      <textarea id="point-logInput" placeholder="在这里输入日志" width="100%"></textarea>

      <button id="point-logConvertButton" width="100%">日志转换</button>
